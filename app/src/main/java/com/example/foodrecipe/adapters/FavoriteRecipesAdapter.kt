...
import com.example.foodrecipe.databinding.FavoriteRecipeRowLayoutBinding
import com.example.foodrecipe.ui.fragments.favorites.FavoriteRecipesFragmentDirections
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        favoriteRecipesRowLayout.setOnClickListener {
            if (multiSelection) {
                ...
                val action =
                    FavoriteRecipesFragmentDirections.actionFavoriteRecepiesFragmentToDetailsActivity(
